 ...
 */
@NonNullByDefault
public class IntellifireFanHandler extends IntellifireThingHandler {
    private final Logger logger = LoggerFactory.getLogger(IntellifireFanHandler.class);

    public IntellifireFanHandler(Thing thing) {
        super(thing);
    }
