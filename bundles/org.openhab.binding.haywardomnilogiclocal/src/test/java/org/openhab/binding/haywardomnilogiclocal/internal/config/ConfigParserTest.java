...
public class ConfigParserTest {
    ...
    public void testParsePopulatesAllListsAndAttributes() throws IOException {
        ...
        assertEquals("5", filter.getMinPrimingInterval());
        assertEquals("yes", filter.getPrimingEnabled());
        assertEquals("60", filter.getPrimingDuration());
        assertEquals("120", filter.getCooldownDuration());
        assertEquals("30", filter.getShutdownRequestTimeout());
        assertEquals("yes", filter.getNoWaterFlowTimeoutEnable());
        assertEquals("240", filter.getNoWaterFlowTimeoutTimeout());
        assertEquals("no", filter.getValveChangeOffEnable());
        assertEquals("10", filter.getValveChangeOffDuration());
        assertEquals("yes", filter.getFreezeProtectEnable());
        assertEquals("37", filter.getFreezeProtectTemp());
        assertEquals("65", filter.getFreezeProtectSpeed());
        assertEquals("45", filter.getSharedFilterTimeout());
        assertEquals("FLT_VALVES_POS_POOL_ONLY", filter.getFilterValvePosition());
        assertEquals("90", filter.getFreezeProtectOverrideInterval());
